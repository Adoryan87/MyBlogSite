...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Adoryan\PycharmProjects\Starting+Files+-+blog-with-users-start'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Adoryan\PycharmProjects\Starting+Files+-+blog-with-users-start\Scripts\deactivate.nu'
